...
def main(args):
    ...
    model = EvaNet(args.batch_size, args.input_channel, args.pred_channel, ultrasmall = args.small_model).to(DEVICE)
    # print(model)
    ...
    if args.mode == 'training':
        ...
        for epoch in range(resume_epoch, args.epochs):
            ...
            for data_dict in tqdm(train_loader):
                ...
                ## Backprop Loss
                optimizer.zero_grad() 
                loss = criterion.forward(pred, elev_data, labels)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_channel', default = 3 , type = int, help = "Input Channel of Image")
    parser.add_argument('--pred_channel', default = 2 , type = int, help = "No. of channels in output prediction")
    parser.add_argument('--epochs', default = 350 , type = int, help = "No. of epochs to train model")
    parser.add_argument('--val_freq', default = 1 , type = int, help = "No. of times to run evaluation during training")
